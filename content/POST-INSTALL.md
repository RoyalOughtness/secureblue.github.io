...
To mitigate [LD_PRELOAD attacks](https://github.com/Aishou/wayland-keylogger), run the command below. Note that this is only effective against opportunistic malware and is a weak stopgap until we develop improved SELinux policies for the homedir.
